...
## [4.36.0](https://github.com/MitchellThompkins/api/compare/v4.35.1...v4.36.0) (2026-06-28)


### Features

* `createDockerFolder` & `setDockerFolderChildren` mutations ([#1558](https://github.com/MitchellThompkins/api/issues/1558)) ([557b03f](https://github.com/MitchellThompkins/api/commit/557b03f8829d3f179b5e26162fa250121cb33420))
* `deleteDockerEntries` mutation ([#1564](https://github.com/MitchellThompkins/api/issues/1564)) ([78997a0](https://github.com/MitchellThompkins/api/commit/78997a02c6d96ec0ed75352dfc9849524147428c))
* add `moveDockerEntriesToFolder` mutation ([#1569](https://github.com/MitchellThompkins/api/issues/1569)) ([20c2d5b](https://github.com/MitchellThompkins/api/commit/20c2d5b4457ad50d1e287fb3141aa98e8e7de665))
* add `parityCheckStatus` field to `array` query ([#1611](https://github.com/MitchellThompkins/api/issues/1611)) ([c508366](https://github.com/MitchellThompkins/api/commit/c508366702b9fa20d9ed05559fe73da282116aa6))
* add cpu power query & subscription ([#1745](https://github.com/MitchellThompkins/api/issues/1745)) ([d7aca81](https://github.com/MitchellThompkins/api/commit/d7aca81c60281bfa47fb9113929c1ead6ed3361b))
* add docker -&gt; organizer query ([#1555](https://github.com/MitchellThompkins/api/issues/1555)) ([dfe352d](https://github.com/MitchellThompkins/api/commit/dfe352dfa1bd6aa059cab56357ba6bff5e8ed7cb))
* add docker restart mutation ([#2022](https://github.com/MitchellThompkins/api/issues/2022)) ([b58120c](https://github.com/MitchellThompkins/api/commit/b58120ca1ef484b68d81dffd72d5a307fefca24f))
* add internal boot step to onboarding flow ([#1881](https://github.com/MitchellThompkins/api/issues/1881)) ([337aecc](https://github.com/MitchellThompkins/api/commit/337aecc5c008c6f593df0665e3048885a8756357))
* Add read-only network metrics API ([#2003](https://github.com/MitchellThompkins/api/issues/2003)) ([a1d1eea](https://github.com/MitchellThompkins/api/commit/a1d1eea56861f7c441d3ae1c844146dce407467b))
* add schema publishing to apollo studio ([#1772](https://github.com/MitchellThompkins/api/issues/1772)) ([7e13202](https://github.com/MitchellThompkins/api/commit/7e13202aa1c02803095bb72bb1bcb2472716f53a))
* add tailwind class sort plugin ([#1562](https://github.com/MitchellThompkins/api/issues/1562)) ([ab11e7f](https://github.com/MitchellThompkins/api/commit/ab11e7ff7ff74da1f1cd5e49938459d00bfc846b))
* add Tailwind scoping plugin and integrate into Vite config ([#1722](https://github.com/MitchellThompkins/api/issues/1722)) ([b7afaf4](https://github.com/MitchellThompkins/api/commit/b7afaf463243b073e1ab1083961a16a12ac6c4a3))
* Add TPM licensing availability to registration ([#1908](https://github.com/MitchellThompkins/api/issues/1908)) ([aa162eb](https://github.com/MitchellThompkins/api/commit/aa162eb297b32f3597c1565691327be53975ab30))
* add unraid api status manager ([#1708](https://github.com/MitchellThompkins/api/issues/1708)) ([1d9ce0a](https://github.com/MitchellThompkins/api/commit/1d9ce0aa3d067726c2c880929408c68f53e13e0d))
* add ups monitoring to graphql api ([#1526](https://github.com/MitchellThompkins/api/issues/1526)) ([6ea94f0](https://github.com/MitchellThompkins/api/commit/6ea94f061d5b2e6c6fbfa6949006960501e3f4e7))
* add UPS power ([#1874](https://github.com/MitchellThompkins/api/issues/1874)) ([b531aed](https://github.com/MitchellThompkins/api/commit/b531aed73934cc589f296d492e4fa2f674578a1b))
* add workflow_dispatch trigger to schema publishing workflow ([818e7ce](https://github.com/MitchellThompkins/api/commit/818e7ce997059663e07efcf1dab706bf0d7fc9da))
* add zsh shell detection to install script ([#1539](https://github.com/MitchellThompkins/api/issues/1539)) ([50ea2a3](https://github.com/MitchellThompkins/api/commit/50ea2a3ffb82b30152fb85e0fb9b0d178d596efe))
* **api:** add cpu utilization query and subscription ([#1590](https://github.com/MitchellThompkins/api/issues/1590)) ([2b4c2a2](https://github.com/MitchellThompkins/api/commit/2b4c2a264bb2769f88c3000d16447889cae57e98))
* **api:** alert when usb boot has internal boot target ([#1898](https://github.com/MitchellThompkins/api/issues/1898)) ([b94df47](https://github.com/MitchellThompkins/api/commit/b94df47fc7b7682a6c531c312d6cdf2ff3341289))
* **api:** determine if docker container has update ([#1582](https://github.com/MitchellThompkins/api/issues/1582)) ([e57d81e](https://github.com/MitchellThompkins/api/commit/e57d81e0735772758bb85e0b3c89dce15c56635e))
* **api:** enhance OIDC redirect URI handling in service and tests ([#1618](https://github.com/MitchellThompkins/api/issues/1618)) ([4e945f5](https://github.com/MitchellThompkins/api/commit/4e945f5f56ce059eb275a9576caf3194a5df8a90))
* **api:** expose internal boot devices in array GraphQL ([#1894](https://github.com/MitchellThompkins/api/issues/1894)) ([0736709](https://github.com/MitchellThompkins/api/commit/07367093e7117463610bda7b91e9ac2ed49b579a))
* **api:** restructure versioning information in GraphQL schema ([#1600](https://github.com/MitchellThompkins/api/issues/1600)) ([d0c6602](https://github.com/MitchellThompkins/api/commit/d0c66020e1d1d5b6fcbc4ee8979bba4b3d34c7ad))
* **api:** support encrypted array start inputs ([#1944](https://github.com/MitchellThompkins/api/issues/1944)) ([018a8d5](https://github.com/MitchellThompkins/api/commit/018a8d5251ad4b69bb11763296ca97dbbeb26582))
* apollo studio readme link ([c4cd0c6](https://github.com/MitchellThompkins/api/commit/c4cd0c63520deec15d735255f38811f0360fe3a1))
* build out docker components  ([#1427](https://github.com/MitchellThompkins/api/issues/1427)) ([711cc9a](https://github.com/MitchellThompkins/api/commit/711cc9ac926958bcf2996455b023ad265b041530))
* **cli:** make `unraid-api plugins remove` scriptable ([#1774](https://github.com/MitchellThompkins/api/issues/1774)) ([64eb9ce](https://github.com/MitchellThompkins/api/commit/64eb9ce9b5d1ff4fb1f08d9963522c5d32221ba7))
* connect settings page updated for responsive webgui ([#1585](https://github.com/MitchellThompkins/api/issues/1585)) ([96c120f](https://github.com/MitchellThompkins/api/commit/96c120f9b24d3c91df5e9401917c8994eef36c46))
* **disks:** add isSpinning field to Disk type ([#1527](https://github.com/MitchellThompkins/api/issues/1527)) ([193be3d](https://github.com/MitchellThompkins/api/commit/193be3df3672514be9904e3d4fbdff776470afc0))
* docker overview ([#1855](https://github.com/MitchellThompkins/api/issues/1855)) ([9ef1cf1](https://github.com/MitchellThompkins/api/commit/9ef1cf1eca96254350d9152d43f05ad11dd3811e))
* **docker:** add update actions to container context menu ([#1867](https://github.com/MitchellThompkins/api/issues/1867)) ([4ca3e06](https://github.com/MitchellThompkins/api/commit/4ca3e06fae391942c46ed9aa93ecbc5e714e3e73))
* **docker:** disable containers page file modification ([#1870](https://github.com/MitchellThompkins/api/issues/1870)) ([aaa0372](https://github.com/MitchellThompkins/api/commit/aaa03721044349d86f2d5c6ef72f51637c37de18))
* enhance OIDC claim evaluation with array handling ([#1596](https://github.com/MitchellThompkins/api/issues/1596)) ([b7798b8](https://github.com/MitchellThompkins/api/commit/b7798b82f44aae9a428261270fd9dbde35ff7751))
* generated UI API key management + OAuth-like API Key Flows ([#1609](https://github.com/MitchellThompkins/api/issues/1609)) ([674323f](https://github.com/MitchellThompkins/api/commit/674323fd87bbcc55932e6b28f6433a2de79b7ab0))
* Hide server name in onboarding ([#1993](https://github.com/MitchellThompkins/api/issues/1993)) ([8244015](https://github.com/MitchellThompkins/api/commit/8244015c4e5f8076046e65e62659c67666293635))
* implement OIDC provider management in GraphQL API ([#1563](https://github.com/MitchellThompkins/api/issues/1563)) ([979a267](https://github.com/MitchellThompkins/api/commit/979a267bc5e128a8b789f0123e23c61860ebb11b))
* improve dom content loading by being more efficient about component mounting ([#1716](https://github.com/MitchellThompkins/api/issues/1716)) ([d8b166e](https://github.com/MitchellThompkins/api/commit/d8b166e4b6a718e07783d9c8ac8393b50ec89ae3))
* improved update ui ([#1691](https://github.com/MitchellThompkins/api/issues/1691)) ([a59b363](https://github.com/MitchellThompkins/api/commit/a59b363ebc1e660f854c55d50fc02c823c2fd0cc))
* issues/1597: Temperature Monitoring - Thanks @MitchellThompkins ([a1be458](https://github.com/MitchellThompkins/api/commit/a1be4582009011fe8c2dd022ca7827a5147cc4d9))
* mount vue apps, not web components ([#1639](https://github.com/MitchellThompkins/api/issues/1639)) ([88087d5](https://github.com/MitchellThompkins/api/commit/88087d5201992298cdafa791d5d1b5bb23dcd72b))
* New Crowdin updates ([#1809](https://github.com/MitchellThompkins/api/issues/1809)) ([a7b3f07](https://github.com/MitchellThompkins/api/commit/a7b3f07fd829ec3373d5ec8d1095635ed1069cdb))
* New Crowdin updates ([#1883](https://github.com/MitchellThompkins/api/issues/1883)) ([14a8fa8](https://github.com/MitchellThompkins/api/commit/14a8fa8d494b47a1d60191f992dca6d887c0d6e3))
* New Crowdin updates ([#1994](https://github.com/MitchellThompkins/api/issues/1994)) ([865d9cc](https://github.com/MitchellThompkins/api/commit/865d9cc469e78f20c0dd6e378c6d7d4bbe3fe434))
* notification filter controls pill buttons ([#1718](https://github.com/MitchellThompkins/api/issues/1718)) ([661865f](https://github.com/MitchellThompkins/api/commit/661865f97611cf802f239fde8232f3109281dde6))
* **onboarding:** add new onboarding flows for Unraid OS ([#1746](https://github.com/MitchellThompkins/api/issues/1746)) ([15bd747](https://github.com/MitchellThompkins/api/commit/15bd74777634145a2247df31b288a84ffb71ec8d))
* **onboarding:** add shared loading states ([#1945](https://github.com/MitchellThompkins/api/issues/1945)) ([776c8cc](https://github.com/MitchellThompkins/api/commit/776c8cc8083c64ab7d682eb9a6dd288214581fb5))
* **onboarding:** force reboot after internal boot setup and lock down wizard ([#1966](https://github.com/MitchellThompkins/api/issues/1966)) ([9323b14](https://github.com/MitchellThompkins/api/commit/9323b1487989b2689a25c746ec9ae39f36b65683))
* **onboarding:** route plugin installs through ca.unraid.net/dl proxy ([#2000](https://github.com/MitchellThompkins/api/issues/2000)) ([443227d](https://github.com/MitchellThompkins/api/commit/443227d6d795bad9dcbfb5b8ee00eb8ac8148d74))
* registration and trial actions use Account app ([#1928](https://github.com/MitchellThompkins/api/issues/1928)) ([c2c0425](https://github.com/MitchellThompkins/api/commit/c2c04252234cd762e2fcc866afa0a5ccbc517428))
* remove Unraid API log download functionality ([#1793](https://github.com/MitchellThompkins/api/issues/1793)) ([e4a9b82](https://github.com/MitchellThompkins/api/commit/e4a9b8291b049752a9ff59b17ff50cf464fe0535))
* replace docker overview table with web component (7.3+) ([#1764](https://github.com/MitchellThompkins/api/issues/1764)) ([277ac42](https://github.com/MitchellThompkins/api/commit/277ac420464379e7ee6739c4530271caf7717503))
* Serverside state for onboarding display ([#1936](https://github.com/MitchellThompkins/api/issues/1936)) ([682d51c](https://github.com/MitchellThompkins/api/commit/682d51c41ba0e18d07ab63080ae5f4cfa298eb7f))
* share internal boot state ([#1921](https://github.com/MitchellThompkins/api/issues/1921)) ([8e4d44d](https://github.com/MitchellThompkins/api/commit/8e4d44d0c3bfe89e91cd5cdd6a276b8d2214d14d))
* tailwind v4 ([#1522](https://github.com/MitchellThompkins/api/issues/1522)) ([2c62e0a](https://github.com/MitchellThompkins/api/commit/2c62e0ad09c56d2293b76d07833dfb142c898937))
* translations now use crowdin (translate.unraid.net) ([#1739](https://github.com/MitchellThompkins/api/issues/1739)) ([31c4102](https://github.com/MitchellThompkins/api/commit/31c41027fc3798e47e81c03cd5cf327f84c8c4d5))
* trial extension allowed within 5 days of expiration ([#1490](https://github.com/MitchellThompkins/api/issues/1490)) ([f34a33b](https://github.com/MitchellThompkins/api/commit/f34a33bc9f1a7e135d453d9d31888789bfc3f878))
* upgrade nuxt-custom-elements ([#1461](https://github.com/MitchellThompkins/api/issues/1461)) ([345e83b](https://github.com/MitchellThompkins/api/commit/345e83bfb0904381d784fc77b3dcd3ad7e53d898))
* use persisted theme css to fix flashes on header ([#1784](https://github.com/MitchellThompkins/api/issues/1784)) ([854b403](https://github.com/MitchellThompkins/api/commit/854b403fbd85220a3012af58ce033cf0b8418516))
* **web:** add standalone internal boot wizard ([#1956](https://github.com/MitchellThompkins/api/issues/1956)) ([ea41225](https://github.com/MitchellThompkins/api/commit/ea412259193e96f747fb02d4eb3488b2813ad91b))
* **web:** install and configure nuxt ui ([#1524](https://github.com/MitchellThompkins/api/issues/1524)) ([407585c](https://github.com/MitchellThompkins/api/commit/407585cd40c409175d8e7b861f8d61d8cabc11c9))
* **web:** show TPM move control for trial licenses ([#1911](https://github.com/MitchellThompkins/api/issues/1911)) ([d00fb63](https://github.com/MitchellThompkins/api/commit/d00fb63602654ef67d6d0ae3c61f27552ed63bda))
* when cancelling OS upgrade, delete any plugin files that were d… ([#1823](https://github.com/MitchellThompkins/api/issues/1823)) ([74df938](https://github.com/MitchellThompkins/api/commit/74df938e450def2ee3e2864d4b928f53a68e9eb8))


### Bug Fixes

* **#1729:** api key authorize component not mounted when on Unraid OS ([e9e271a](https://github.com/MitchellThompkins/api/commit/e9e271ade5d5ca359025200e1e6f1680dc956c62))
* activation indicator removed ([5edfd82](https://github.com/MitchellThompkins/api/commit/5edfd823b862cfc1f864565021f12334fe9317c6))
* add cache busting to web component extractor ([#1731](https://github.com/MitchellThompkins/api/issues/1731)) ([0d165a6](https://github.com/MitchellThompkins/api/commit/0d165a608740505bdc505dcf69fb615225969741))
* Add dedicated TPM license move option ([#1909](https://github.com/MitchellThompkins/api/issues/1909)) ([36c56f7](https://github.com/MitchellThompkins/api/commit/36c56f762343604272b4f25769638b02d49a1960))
* add hungarian translation updates' ([a38fa34](https://github.com/MitchellThompkins/api/commit/a38fa348cb88ff399e50ab3c917f0cc390361fb3))
* add missing breakpoints ([#1535](https://github.com/MitchellThompkins/api/issues/1535)) ([f5352e3](https://github.com/MitchellThompkins/api/commit/f5352e3a26a2766e85d19ffb5f74960c536b91b3))
* add missing CPU guest metrics to CPU responses ([#1644](https://github.com/MitchellThompkins/api/issues/1644)) ([99dbad5](https://github.com/MitchellThompkins/api/commit/99dbad57d55a256f5f3f850f9a47a6eaa6348065))
* adjust header styles to fix flashing and width issues - thanks ZarZ ([4759b3d](https://github.com/MitchellThompkins/api/commit/4759b3d0b3fb6bc71636f75f807cd6f4f62305d1))
* allow free USB targets in onboarding internal boot setup ([#1903](https://github.com/MitchellThompkins/api/issues/1903)) ([298da54](https://github.com/MitchellThompkins/api/commit/298da54120b0f78db6b79921e08b4e4ffa754654))
* allow rclone to fail to initialize ([#1453](https://github.com/MitchellThompkins/api/issues/1453)) ([7c6f02a](https://github.com/MitchellThompkins/api/commit/7c6f02a5cb474fb285db294ec6f80d1c2c57e142))
* api auth from web during local dev ([#1743](https://github.com/MitchellThompkins/api/issues/1743)) ([754966d](https://github.com/MitchellThompkins/api/commit/754966d5d34824608fb3c9f774b79612272d5d87))
* api key creation cli ([#1637](https://github.com/MitchellThompkins/api/issues/1637)) ([c147a6b](https://github.com/MitchellThompkins/api/commit/c147a6b5075969e77798210c4a5cfd1fa5b96ae3))
* API key key display truncation ([#1890](https://github.com/MitchellThompkins/api/issues/1890)) ([b12f75c](https://github.com/MitchellThompkins/api/commit/b12f75c49342913441c380bf8e71106b6542b73b))
* api version json response ([#1653](https://github.com/MitchellThompkins/api/issues/1653)) ([292bc0f](https://github.com/MitchellThompkins/api/commit/292bc0fc810a0d0f0cce6813b0631ff25099cc05))
* **api:** connect config `email` validation ([#1454](https://github.com/MitchellThompkins/api/issues/1454)) ([b9a1b9b](https://github.com/MitchellThompkins/api/commit/b9a1b9b08746b6d4cb2128d029a3dab7cdd47677))
* **api:** decode html entities before parsing notifications ([#1768](https://github.com/MitchellThompkins/api/issues/1768)) ([42406e7](https://github.com/MitchellThompkins/api/commit/42406e795da1e5b95622951a467722dde72d51a8))
* **api:** defer docker startup tasks until ready ([#1952](https://github.com/MitchellThompkins/api/issues/1952)) ([0e004a7](https://github.com/MitchellThompkins/api/commit/0e004a7b03b854636d30b019cffef3453865865e))
* **api:** harden PHP wrapper args for newer PHP versions ([#1901](https://github.com/MitchellThompkins/api/issues/1901)) ([849f177](https://github.com/MitchellThompkins/api/commit/849f177ec852876143d680f509edb3a6ca01b6ec))
* **api:** isUpdateAvailable returns null for all containers when cache has an undef entry ([#2030](https://github.com/MitchellThompkins/api/issues/2030)) ([b166407](https://github.com/MitchellThompkins/api/commit/b166407c062f78f4be306b7a5b45288890449afe))
* **api:** keep plugin config loads side-effect free ([#2025](https://github.com/MitchellThompkins/api/issues/2025)) ([3c84326](https://github.com/MitchellThompkins/api/commit/3c84326a95eb870975e02993085659b31a7bfe0e))
* **api:** prevent flash notification startup fd exhaustion ([#1893](https://github.com/MitchellThompkins/api/issues/1893)) ([4b231ad](https://github.com/MitchellThompkins/api/commit/4b231adda4ee300685e7370e3f3e767ad78d7570))
* **api:** reconcile emhttp state without spinning disks ([#1946](https://github.com/MitchellThompkins/api/issues/1946)) ([d3e0b95](https://github.com/MitchellThompkins/api/commit/d3e0b9560d3d71348953241fb6ae37c49d645d5a))
* **api:** timeout on startup on 7.0 and 6.12 ([#1844](https://github.com/MitchellThompkins/api/issues/1844)) ([e243ae8](https://github.com/MitchellThompkins/api/commit/e243ae836ec1a7fde37dceeb106cc693b20ec82b))
* auto-uninstallation of connect api plugin ([#1791](https://github.com/MitchellThompkins/api/issues/1791)) ([e734043](https://github.com/MitchellThompkins/api/commit/e7340431a58821ec1b4f5d1b452fba6613b01fa5))
* backport `<unraid-modals>` upon plg install when necessary ([#1499](https://github.com/MitchellThompkins/api/issues/1499)) ([33e0b1a](https://github.com/MitchellThompkins/api/commit/33e0b1ab24bedb6a2c7b376ea73dbe65bc3044be))
* better component loading to prevent per-page strange behavior ([095c222](https://github.com/MitchellThompkins/api/commit/095c2221c94f144f8ad410a69362b15803765531))
* border color incorrect in tailwind ([#1544](https://github.com/MitchellThompkins/api/issues/1544)) ([f14b74a](https://github.com/MitchellThompkins/api/commit/f14b74af91783b08640c0949c51ba7f18508f06f))
* change config file loading error log to debug ([#1565](https://github.com/MitchellThompkins/api/issues/1565)) ([3534d6f](https://github.com/MitchellThompkins/api/commit/3534d6fdd7c59e65615167cfe306deebad9ca4d3))
* change keyfile watcher to poll instead of inotify on FAT32 ([#1820](https://github.com/MitchellThompkins/api/issues/1820)) ([23a7120](https://github.com/MitchellThompkins/api/commit/23a71207ddde221867562b722f4e65a5fc4dd744))
* check mdState to determine array stopped during onboarding ([#1969](https://github.com/MitchellThompkins/api/issues/1969)) ([abe7283](https://github.com/MitchellThompkins/api/commit/abe72837a9798e9d4bb6b0f34c06c8ff942f1f31))
* Clarify missing license device status ([#1999](https://github.com/MitchellThompkins/api/issues/1999)) ([3f2cf18](https://github.com/MitchellThompkins/api/commit/3f2cf18ab42505358f975ab28eac2a63474fbcf8))
* cleanup ini parser logic with better fallbacks ([#1713](https://github.com/MitchellThompkins/api/issues/1713)) ([1691362](https://github.com/MitchellThompkins/api/commit/16913627de9497a5d2f71edb710cec6e2eb9f890))
* cleanup leftover removed packages on upgrade ([#1719](https://github.com/MitchellThompkins/api/issues/1719)) ([9972a5f](https://github.com/MitchellThompkins/api/commit/9972a5f178f9a251e6c129d85c5f11cfd25e6281))
* cleanup obsoleted legacy api keys on api startup (cli / connect) ([#1630](https://github.com/MitchellThompkins/api/issues/1630)) ([6469d00](https://github.com/MitchellThompkins/api/commit/6469d002b7b18e49c77ee650a4255974ab43e790))
* clear stale onboarding modal session state ([#1904](https://github.com/MitchellThompkins/api/issues/1904)) ([23f7836](https://github.com/MitchellThompkins/api/commit/23f78366642106277239f2f23d770259cfe78416))
* **cli:** support `--log-level` for `start` and `restart` cmds ([#1623](https://github.com/MitchellThompkins/api/issues/1623)) ([a1ee915](https://github.com/MitchellThompkins/api/commit/a1ee915ca52e5a063eccf8facbada911a63f37f6))
* confusing server -&gt; status query ([#1635](https://github.com/MitchellThompkins/api/issues/1635)) ([9d42b36](https://github.com/MitchellThompkins/api/commit/9d42b36f74274cad72490da5152fdb98fdc5b89b))
* Connect won't appear within Apps - Previous Apps ([#1727](https://github.com/MitchellThompkins/api/issues/1727)) ([d73953f](https://github.com/MitchellThompkins/api/commit/d73953f8ff3d7425c0aed32d16236ededfd948e1))
* **connect:** clear `wanport` upon disabling remote access ([#1624](https://github.com/MitchellThompkins/api/issues/1624)) ([9df6a3f](https://github.com/MitchellThompkins/api/commit/9df6a3f5ebb0319aa7e3fe3be6159d39ec6f587f))
* **connect:** disable api plugin if unraid plugin is absent ([#1773](https://github.com/MitchellThompkins/api/issues/1773)) ([c264a18](https://github.com/MitchellThompkins/api/commit/c264a1843cf115e8cc1add1ab4f12fdcc932405a))
* **connect:** expose IPv6 FQDN routes ([#1976](https://github.com/MitchellThompkins/api/issues/1976)) ([86d31ee](https://github.com/MitchellThompkins/api/commit/86d31ee4e2ba958d070a7d1e06f5ba68ea78f2d9))
* **connect:** fatal race-condition in websocket disposal ([#1462](https://github.com/MitchellThompkins/api/issues/1462)) ([0ec0de9](https://github.com/MitchellThompkins/api/commit/0ec0de982f017b61a145c7a4176718b484834f41))
* **connect:** mothership connection ([#1464](https://github.com/MitchellThompkins/api/issues/1464)) ([7be8bc8](https://github.com/MitchellThompkins/api/commit/7be8bc84d3831f9cea7ff62d0964612ad366a976))
* **connect:** omit extraneous fields during connect config validation ([#1538](https://github.com/MitchellThompkins/api/issues/1538)) ([45bd736](https://github.com/MitchellThompkins/api/commit/45bd73698b2bd534a8aff2c6ac73403de6c58561))
* **connect:** remove unraid-api folder before creating symlink ([#1556](https://github.com/MitchellThompkins/api/issues/1556)) ([514a0ef](https://github.com/MitchellThompkins/api/commit/514a0ef560a90595f774b6c0db60f1d2b4cd853c))
* **connect:** rm eager restart on `ERROR_RETYING` connection status ([#1502](https://github.com/MitchellThompkins/api/issues/1502)) ([dd759d9](https://github.com/MitchellThompkins/api/commit/dd759d9f0f841b296f8083bc67c6cd3f7a69aa5b))
* **connect:** valid LAN FQDN while remote access is enabled ([#1625](https://github.com/MitchellThompkins/api/issues/1625)) ([aa58888](https://github.com/MitchellThompkins/api/commit/aa588883cc2e2fe4aa4aea1d035236c888638f5b))
* consistently clear onboarding draft ([#1916](https://github.com/MitchellThompkins/api/issues/1916)) ([199d803](https://github.com/MitchellThompkins/api/commit/199d80332ddad53d5ba98c995df95afd224832bf))
* console hidden ([9b85e00](https://github.com/MitchellThompkins/api/commit/9b85e009b833706294a841a54498e45a8e0204ed))
* correct graphql-api.log timestamp formatting ([#1918](https://github.com/MitchellThompkins/api/issues/1918)) ([243c5a8](https://github.com/MitchellThompkins/api/commit/243c5a8c481dd430d5ef11905846c85b8eb9c34f))
* correctly parse periods in share names from ini file ([#1629](https://github.com/MitchellThompkins/api/issues/1629)) ([7d67a40](https://github.com/MitchellThompkins/api/commit/7d67a404333a38d6e1ba5c3febf02be8b1b71901))
* **cpu:** add legacy telemetry fallbacks ([#2011](https://github.com/MitchellThompkins/api/issues/2011)) ([97f5425](https://github.com/MitchellThompkins/api/commit/97f54251f5d59c2265554e0859aa3d2046f53039))
* custom path detection to fix setup issues ([#1664](https://github.com/MitchellThompkins/api/issues/1664)) ([2ecdb99](https://github.com/MitchellThompkins/api/commit/2ecdb99052f39d89af21bbe7ad3f80b83bb1eaa9))
* DefaultPageLayout patch rollback omits legacy header logo ([#1497](https://github.com/MitchellThompkins/api/issues/1497)) ([ea20d1e](https://github.com/MitchellThompkins/api/commit/ea20d1e2116fcafa154090fee78b42ec5d9ba584))
* delay `nginx:reload` file mod effect by 10 seconds ([#1512](https://github.com/MitchellThompkins/api/issues/1512)) ([af33e99](https://github.com/MitchellThompkins/api/commit/af33e999a0480a77e3e6b2aa833b17b38b835656))
* **deps:** pin dependencies ([#1465](https://github.com/MitchellThompkins/api/issues/1465)) ([ba75a40](https://github.com/MitchellThompkins/api/commit/ba75a409a4d3e820308b78fd5a5380021d3757b0))
* **deps:** pin dependencies ([#1470](https://github.com/MitchellThompkins/api/issues/1470)) ([412b329](https://github.com/MitchellThompkins/api/commit/412b32996d9c8352c25309cc0d549a57468d0fb5))
* **deps:** pin dependencies ([#1528](https://github.com/MitchellThompkins/api/issues/1528)) ([a74d935](https://github.com/MitchellThompkins/api/commit/a74d935b566dd7af1a21824c9b7ab562232f9d8b))
* **deps:** pin dependencies ([#1586](https://github.com/MitchellThompkins/api/issues/1586)) ([5721785](https://github.com/MitchellThompkins/api/commit/57217852a337ead4c8c8e7596d1b7d590b64a26f))
* **deps:** pin dependencies ([#1669](https://github.com/MitchellThompkins/api/issues/1669)) ([413db4b](https://github.com/MitchellThompkins/api/commit/413db4bd30a06aa69d3ca86e793782854f822589))
* **deps:** pin dependencies ([#1878](https://github.com/MitchellThompkins/api/issues/1878)) ([db88eb8](https://github.com/MitchellThompkins/api/commit/db88eb8ca92b5231c7f01e23c39d95c4cdbf9925))
* **deps:** pin dependency @nuxt/ui to 3.2.0 ([#1532](https://github.com/MitchellThompkins/api/issues/1532)) ([8279531](https://github.com/MitchellThompkins/api/commit/8279531f2b86a78e81a77e6c037a0fb752e98062))
* **deps:** pin dependency conventional-changelog-conventionalcommits to 9.1.0 ([#1697](https://github.com/MitchellThompkins/api/issues/1697)) ([9a86c61](https://github.com/MitchellThompkins/api/commit/9a86c615da2e975f568922fa012cc29b3f9cde0e))
* **deps:** storybook v9 ([#1476](https://github.com/MitchellThompkins/api/issues/1476)) ([45bb49b](https://github.com/MitchellThompkins/api/commit/45bb49bcd60a9753be492203111e489fd37c1a5f))
* **deps:** update all non-major dependencies ([#1489](https://github.com/MitchellThompkins/api/issues/1489)) ([53b05eb](https://github.com/MitchellThompkins/api/commit/53b05ebe5e2050cb0916fcd65e8d41370aee0624))
* **deps:** update all non-major dependencies ([#1510](https://github.com/MitchellThompkins/api/issues/1510)) ([1a8da6d](https://github.com/MitchellThompkins/api/commit/1a8da6d92b96d3afa2a8b42446b36f1ee98b64a0))
* **deps:** update all non-major dependencies ([#1520](https://github.com/MitchellThompkins/api/issues/1520)) ([e2fa648](https://github.com/MitchellThompkins/api/commit/e2fa648d1cf5a6cbe3e55c3f52c203d26bb4d526))
* **deps:** update all non-major dependencies ([#1543](https://github.com/MitchellThompkins/api/issues/1543)) ([18b5209](https://github.com/MitchellThompkins/api/commit/18b52090874c0ba86878d0f7e31bf0dc42734d75))
* **deps:** update all non-major dependencies ([#1579](https://github.com/MitchellThompkins/api/issues/1579)) ([ad6aa3b](https://github.com/MitchellThompkins/api/commit/ad6aa3b6743aeeb42eff34d1c89ad874dfd0af09))
* **deps:** update dependency camelcase-keys to v10 ([#1687](https://github.com/MitchellThompkins/api/issues/1687)) ([95faeaa](https://github.com/MitchellThompkins/api/commit/95faeaa2f39bf7bd16502698d7530aaa590b286d))
* **deps:** update dependency dotenv to v17 ([#1474](https://github.com/MitchellThompkins/api/issues/1474)) ([d613bfa](https://github.com/MitchellThompkins/api/commit/d613bfa0410e7ef8451fc8ea20e57a7db67f7994))
* **deps:** update dependency filenamify to v7 ([#1703](https://github.com/MitchellThompkins/api/issues/1703)) ([b80988a](https://github.com/MitchellThompkins/api/commit/b80988aaabebc4b8dbf2bf31f0764bf2f28e1575))
* **deps:** update dependency marked to v16 ([#1444](https://github.com/MitchellThompkins/api/issues/1444)) ([453a5b2](https://github.com/MitchellThompkins/api/commit/453a5b2c9591f755ce07548a9996d7a6cf0925c4))
* **deps:** update dependency p-retry to v7 ([#1608](https://github.com/MitchellThompkins/api/issues/1608)) ([c782cf0](https://github.com/MitchellThompkins/api/commit/c782cf0e8710c6690050376feefda3edb30dd549))
* **deps:** update dependency uuid to v13 ([#1688](https://github.com/MitchellThompkins/api/issues/1688)) ([2fef10c](https://github.com/MitchellThompkins/api/commit/2fef10c94aae910e95d9f5bcacf7289e2cca6ed9))
* **deps:** update dependency vue-sonner to v2 ([#1475](https://github.com/MitchellThompkins/api/issues/1475)) ([f95ca9c](https://github.com/MitchellThompkins/api/commit/f95ca9c9cb69725dcf3bb4bcbd0b558a2074e311))
* **deps:** update graphqlcodegenerator monorepo (major) ([#1689](https://github.com/MitchellThompkins/api/issues/1689)) ([ba4a43a](https://github.com/MitchellThompkins/api/commit/ba4a43aec863fc30c47dd17370d74daed7f84703))
* detection of flash backup activation state ([#1769](https://github.com/MitchellThompkins/api/issues/1769)) ([d18eaf2](https://github.com/MitchellThompkins/api/commit/d18eaf2364e0c04992c52af38679ff0a0c570440))
* display settings fix for languages on less than 7.2-beta.2.3 ([#1696](https://github.com/MitchellThompkins/api/issues/1696)) ([03dae7c](https://github.com/MitchellThompkins/api/commit/03dae7ce66b3409593eeee90cd5b56e2a920ca44))
* do not uninstall fully on 7.2 ([#1484](https://github.com/MitchellThompkins/api/issues/1484)) ([2263881](https://github.com/MitchellThompkins/api/commit/22638811a9fdb524420b1347ac49cfaa51bbecb5))
* **docker:** change "visit" to "webui" & use correct link ([#1863](https://github.com/MitchellThompkins/api/issues/1863)) ([cab0880](https://github.com/MitchellThompkins/api/commit/cab0880263f3b59a8974e64a9c28c10e3608678f))
* **docker:** guard primary container name access ([#1977](https://github.com/MitchellThompkins/api/issues/1977)) ([7dadaa2](https://github.com/MitchellThompkins/api/commit/7dadaa2334711e8a18ac3904c15e28636bcf2f96))
* **docker:** improve start/stop UX with visual feedback ([#1865](https://github.com/MitchellThompkins/api/issues/1865)) ([c084e25](https://github.com/MitchellThompkins/api/commit/c084e25db9eae3cc47f4803861a867feeaf4509f))
* **docker:** remove aggressive caching to ensure data correctness ([#1864](https://github.com/MitchellThompkins/api/issues/1864)) ([1c1bae8](https://github.com/MitchellThompkins/api/commit/1c1bae8ce1c1ffc478e62acb176565a1e524e74c))
* **docker:** sync template mappings in organizer to prevent false orphan warnings ([#1866](https://github.com/MitchellThompkins/api/issues/1866)) ([38a6f0c](https://github.com/MitchellThompkins/api/commit/38a6f0c380e7a84b1dd08170419dad557ed0880f))
* drop console with terser ([a87d455](https://github.com/MitchellThompkins/api/commit/a87d455bace04aab9d7fa0e63cb61d26ef9b3b72))
* duplicated header logo after api stops ([#1493](https://github.com/MitchellThompkins/api/issues/1493)) ([4168f43](https://github.com/MitchellThompkins/api/commit/4168f43e3ecd51479bec3aae585abbe6dcd3e416))
* empty commit to release as 4.28.1 ([df78608](https://github.com/MitchellThompkins/api/commit/df786084572eefb82e086c15939b50cc08b9db10))
* enable auth guard for nested fields - thanks [@ingel81](https://github.com/ingel81) ([7bdeca8](https://github.com/MitchellThompkins/api/commit/7bdeca8338a3901f15fde06fd7aede3b0c16e087))
* enhance activation code modal visibility logic ([#1733](https://github.com/MitchellThompkins/api/issues/1733)) ([e57ec00](https://github.com/MitchellThompkins/api/commit/e57ec00627e54ce76d903fd0fa8686ad02b393f3))
* enhance dark mode support in theme handling ([#1808](https://github.com/MitchellThompkins/api/issues/1808)) ([d6e2939](https://github.com/MitchellThompkins/api/commit/d6e29395c8a8b0215d4f5945775de7fa358d06ec))
* enhance DOM validation and cleanup in vue-mount-app ([6cf7c88](https://github.com/MitchellThompkins/api/commit/6cf7c88242f2f4fe9f83871560039767b5b90273))
* enhance getKeyFile function to handle missing key file gracefully ([#1659](https://github.com/MitchellThompkins/api/issues/1659)) ([728b38a](https://github.com/MitchellThompkins/api/commit/728b38ac11faeacd39ce9d0157024ad140e29b36))
* enhance plugin management with interactive removal prompts ([#1549](https://github.com/MitchellThompkins/api/issues/1549)) ([23ef760](https://github.com/MitchellThompkins/api/commit/23ef760d763c525a38108048200fa73fc8531aed))
* enhance user context validation in auth module ([#1726](https://github.com/MitchellThompkins/api/issues/1726)) ([cd5eff1](https://github.com/MitchellThompkins/api/commit/cd5eff11bcb4398581472966cb7ec124eac7ad0a))
* enhance version comparison logic in installation script ([d9c561b](https://github.com/MitchellThompkins/api/commit/d9c561bfebed0c553fe4bfa26b088ae71ca59755))
* ensure no crash if emhttp state configs are missing ([#1514](https://github.com/MitchellThompkins/api/issues/1514)) ([1a7d35d](https://github.com/MitchellThompkins/api/commit/1a7d35d3f6972fd8aff58c17b2b0fb79725e660e))
* error logs from `cloud` query when connect is not installed ([#1450](https://github.com/MitchellThompkins/api/issues/1450)) ([719f460](https://github.com/MitchellThompkins/api/commit/719f460016d769255582742d7d71ca97d132022b))
* event emitter setup for writing status ([#1496](https://github.com/MitchellThompkins/api/issues/1496)) ([ca4e2db](https://github.com/MitchellThompkins/api/commit/ca4e2db1f29126a1fa3784af563832edda64b0ca))
* false positive on verify_install script being external shell ([#1704](https://github.com/MitchellThompkins/api/issues/1704)) ([31a255c](https://github.com/MitchellThompkins/api/commit/31a255c9281b29df983d0f5d0475cd5a69790a48))
* flaky watch on boot drive's dynamix config ([#1753](https://github.com/MitchellThompkins/api/issues/1753)) ([34075e4](https://github.com/MitchellThompkins/api/commit/34075e44c551a8fec3d294e1ed127699f1e560f2))
* flash backup integration with Unraid Connect config ([#1448](https://github.com/MitchellThompkins/api/issues/1448)) ([038c582](https://github.com/MitchellThompkins/api/commit/038c582aed5f5efaea3583372778b9baa318e1ea))
* forked plugin publish workflow ([#2014](https://github.com/MitchellThompkins/api/issues/2014)) ([eb60d4d](https://github.com/MitchellThompkins/api/commit/eb60d4d1535a322f14b7ad28c5c2cdb75a3ab819))
* handle race condition between guid loading and license check ([#1847](https://github.com/MitchellThompkins/api/issues/1847)) ([8b155d1](https://github.com/MitchellThompkins/api/commit/8b155d1f1c99bb19efbc9614e000d852e9f0c12d))
* header background color issues fixed on 7.2 - thanks Nick! ([73c1100](https://github.com/MitchellThompkins/api/commit/73c1100d0ba396fe4342f8ce7561017ab821e68b))
* header padding regression ([#1477](https://github.com/MitchellThompkins/api/issues/1477)) ([e791cc6](https://github.com/MitchellThompkins/api/commit/e791cc680de9c40378043348ddca70902da6d250))
* **HeaderOsVersion:** adjust top margin for header component ([#1485](https://github.com/MitchellThompkins/api/issues/1485)) ([862b54d](https://github.com/MitchellThompkins/api/commit/862b54de8cd793606f1d29e76c19d4a0e1ae172f))
* hide reset help option when sso is being checked ([#1695](https://github.com/MitchellThompkins/api/issues/1695)) ([222ced7](https://github.com/MitchellThompkins/api/commit/222ced7518d40c207198a3b8548f0e024bc865b0))
* improve API startup reliability with timeout budget tracking ([#1824](https://github.com/MitchellThompkins/api/issues/1824)) ([51f025b](https://github.com/MitchellThompkins/api/commit/51f025b105487b178048afaabf46b260c4a7f9c1))
* improve vue mount speed by 10x ([c855caa](https://github.com/MitchellThompkins/api/commit/c855caa9b2d4d63bead1a992f5c583e00b9ba843))
* info alert docker icon ([#1661](https://github.com/MitchellThompkins/api/issues/1661)) ([239cdd6](https://github.com/MitchellThompkins/api/commit/239cdd6133690699348e61f68e485d2b54fdcbdb))
* inject Tailwind CSS into client entry point ([#1537](https://github.com/MitchellThompkins/api/issues/1537)) ([86b6c4f](https://github.com/MitchellThompkins/api/commit/86b6c4f85b7b30bb4a13d57450a76bf4c28a3fff))
* insecure routes not working for SSO ([#1587](https://github.com/MitchellThompkins/api/issues/1587)) ([a4ff3c4](https://github.com/MitchellThompkins/api/commit/a4ff3c40926915f6989ed4af679b30cf295ea15d))
* invalid configs no longer crash API ([#1491](https://github.com/MitchellThompkins/api/issues/1491)) ([6bf3f77](https://github.com/MitchellThompkins/api/commit/6bf3f776380edeff5133517e6aca223556e30144))
* invalid state for unraid plugin ([#1492](https://github.com/MitchellThompkins/api/issues/1492)) ([39b8f45](https://github.com/MitchellThompkins/api/commit/39b8f453da23793ef51f8e7f7196370aada8c5aa))
* issue with header flashing + issue with trial date ([64875ed](https://github.com/MitchellThompkins/api/commit/64875edbba786a0d1ba0113c9e9a3d38594eafcc))
* issue with incorrect permissions on viewer / other roles ([378cdb7](https://github.com/MitchellThompkins/api/commit/378cdb7f102f63128dd236c13f1a3745902d5a2c))
* lanip copy button not present ([#1459](https://github.com/MitchellThompkins/api/issues/1459)) ([a280786](https://github.com/MitchellThompkins/api/commit/a2807864acef742e454d87bb093ee91806e527e5))
* **logging:** remove colorized logs ([#1705](https://github.com/MitchellThompkins/api/issues/1705)) ([1d2c670](https://github.com/MitchellThompkins/api/commit/1d2c6701ce56b1d40afdb776065295e9273d08e9))
* make settings grid responsive ([#1463](https://github.com/MitchellThompkins/api/issues/1463)) ([9dfdb8d](https://github.com/MitchellThompkins/api/commit/9dfdb8dce781fa662d6434ee432e4521f905ffa5))
* minor duplicate click handler and version resolver nullability issue ([ac198d5](https://github.com/MitchellThompkins/api/commit/ac198d5d1a3073fdeb053c2ff8f704b0dba0d047))
* missing translations for expiring trials ([#1800](https://github.com/MitchellThompkins/api/issues/1800)) ([36c1049](https://github.com/MitchellThompkins/api/commit/36c104915ece203a3cac9e1a13e0c325e536a839))
* **my.servers:** improve DNS resolution robustness for backup server ([#1518](https://github.com/MitchellThompkins/api/issues/1518)) ([eecd9b1](https://github.com/MitchellThompkins/api/commit/eecd9b1017a63651d1dc782feaa224111cdee8b6))
* no sizeRootFs unless queried ([#1710](https://github.com/MitchellThompkins/api/issues/1710)) ([9714b21](https://github.com/MitchellThompkins/api/commit/9714b21c5c07160b92a11512e8b703908adb0620))
* **notifications:** gracefully handle & mask invalid notifications ([#1529](https://github.com/MitchellThompkins/api/issues/1529)) ([05056e7](https://github.com/MitchellThompkins/api/commit/05056e7ca1702eb7bf6c507950460b6b15bf7916))
* OIDC and API Key management issues ([#1642](https://github.com/MitchellThompkins/api/issues/1642)) ([0fe2c2c](https://github.com/MitchellThompkins/api/commit/0fe2c2c1c85dcc547e4b1217a3b5636d7dd6d4b4))
* oidc cache busting issues fixed ([#1656](https://github.com/MitchellThompkins/api/issues/1656)) ([e204eb8](https://github.com/MitchellThompkins/api/commit/e204eb80a00ab9242e3dca4ccfc3e1b55a7694b7))
* **oidc:** trust Fastify proxy metadata ([#1982](https://github.com/MitchellThompkins/api/issues/1982)) ([ad494d7](https://github.com/MitchellThompkins/api/commit/ad494d793ba8ff8ddcfa812bdf9d607acafbbb1b))
* onboarding internal-boot warning panel contrast and semantics ([#1927](https://github.com/MitchellThompkins/api/issues/1927)) ([bb6f241](https://github.com/MitchellThompkins/api/commit/bb6f2419d196449f492c5d9bbdae44f16cfc4952))
* **onboarding:** add explicit EFI loader path for flash entry ([#1926](https://github.com/MitchellThompkins/api/issues/1926)) ([429b438](https://github.com/MitchellThompkins/api/commit/429b4384a57a0793f019a0d5d8ea13e556fa9646))
* **onboarding:** auto-open incomplete onboarding on 7.3+ ([#1940](https://github.com/MitchellThompkins/api/issues/1940)) ([f0241a8](https://github.com/MitchellThompkins/api/commit/f0241a8ef3f70d3a5a395439513b30e2e9812120))
* **onboarding:** extend onboarding refresh timeout ([#1925](https://github.com/MitchellThompkins/api/issues/1925)) ([e2a5f44](https://github.com/MitchellThompkins/api/commit/e2a5f44dc4a8fa07e1aae5383ecf6f7a65963d3c))
* **onboarding:** fix shutdown/reboot buttons in internal boot wizard ([#1972](https://github.com/MitchellThompkins/api/issues/1972)) ([7f04f8e](https://github.com/MitchellThompkins/api/commit/7f04f8eda4098feadb840311221c0ae9cbf7b5e2))
* **onboarding:** hide boot pool info alert when storage boot is unavailable ([#1973](https://github.com/MitchellThompkins/api/issues/1973)) ([f82681b](https://github.com/MitchellThompkins/api/commit/f82681bb38ad3668f5abdc679678771a7bccf17a))
* **onboarding:** lower dedicated boot minimum to 6 GiB ([#1979](https://github.com/MitchellThompkins/api/issues/1979)) ([c8773f5](https://github.com/MitchellThompkins/api/commit/c8773f527f26f1e22d87306c7c68c6c0e1bee830))
* **onboarding:** persist installed plugins in summary ([#1915](https://github.com/MitchellThompkins/api/issues/1915)) ([07f4ebd](https://github.com/MitchellThompkins/api/commit/07f4ebdf8f2da679512d74c917410ab761e4c757))
* **onboarding:** prevent Apply Result dialog from being dismissed ([#1971](https://github.com/MitchellThompkins/api/issues/1971)) ([0db1410](https://github.com/MitchellThompkins/api/commit/0db14107aa542e2bfe2d1a5d216fadcb40d96622))
* **onboarding:** refine storage boot setup UX ([#1900](https://github.com/MitchellThompkins/api/issues/1900)) ([1108d0a](https://github.com/MitchellThompkins/api/commit/1108d0a5956677abe94b3aa8ed0230e83c8064ff))
* **onboarding:** reload after server rename ([#1981](https://github.com/MitchellThompkins/api/issues/1981)) ([6897f7e](https://github.com/MitchellThompkins/api/commit/6897f7ee10ee23c57e5638c9f07162377bb79632))
* **onboarding:** replace internal boot native selects ([#1942](https://github.com/MitchellThompkins/api/issues/1942)) ([d6ea032](https://github.com/MitchellThompkins/api/commit/d6ea032c7f5cc687f7952d4deec39a4c2040ea3a))
* **onboarding:** reset internal boot form on mode switch ([#1980](https://github.com/MitchellThompkins/api/issues/1980)) ([a78b895](https://github.com/MitchellThompkins/api/commit/a78b895a0c5f28798d33222ed2002c2d7f8f74c2))
* **onboarding:** restore page refresh on Go to Dashboard ([#1967](https://github.com/MitchellThompkins/api/issues/1967)) ([29f814b](https://github.com/MitchellThompkins/api/commit/29f814b9618b6981a5a2ce2b1a9670a35eb09e26))
* **onboarding:** separate apply and completion flows ([#1948](https://github.com/MitchellThompkins/api/issues/1948)) ([5be53a4](https://github.com/MitchellThompkins/api/commit/5be53a4e53f2daa606dc6d1e27e19471f42cae5d))
* **onboarding:** surface drive warnings for internal boot ([#1963](https://github.com/MitchellThompkins/api/issues/1963)) ([9e0e89e](https://github.com/MitchellThompkins/api/commit/9e0e89ec3182110d906cbdf13a9ff033f0282349))
* over-eager cloud query from web components ([#1506](https://github.com/MitchellThompkins/api/issues/1506)) ([074370c](https://github.com/MitchellThompkins/api/commit/074370c42cdecc4dbc58193ff518aa25735c56b3))
* **parity:** resume continues from saved position instead of restarting ([#2009](https://github.com/MitchellThompkins/api/issues/2009)) ([329f66f](https://github.com/MitchellThompkins/api/commit/329f66f7c14a9b6ccf2bd6b46eaa38e526118038))
* parsing of `ssoEnabled` in state.php ([#1455](https://github.com/MitchellThompkins/api/issues/1455)) ([f542c8e](https://github.com/MitchellThompkins/api/commit/f542c8e0bd9596d9d3abf75b58b97d95fb033215))
* PHP Warnings in Management Settings ([#1805](https://github.com/MitchellThompkins/api/issues/1805)) ([832e9d0](https://github.com/MitchellThompkins/api/commit/832e9d04f207d3ec612c98500a2ffc86659264e5))
* pin ranges ([#1460](https://github.com/MitchellThompkins/api/issues/1460)) ([f88400e](https://github.com/MitchellThompkins/api/commit/f88400eea820ac80c867fdb63cd503ed91493146))
* **plg:** explicitly stop an existing api before installation ([#1841](https://github.com/MitchellThompkins/api/issues/1841)) ([99ce88b](https://github.com/MitchellThompkins/api/commit/99ce88bfdc0a7f020c42f2fe0c6a0f4e32ac8f5a))
* **plugin:** add fallback for unraid-api stop in deprecation cleanup ([#1668](https://github.com/MitchellThompkins/api/issues/1668)) ([797bf50](https://github.com/MitchellThompkins/api/commit/797bf50ec702ebc8244ff71a8ef1a80ea5cd2169))
* **plugin:** preserve Connect during install start ([#2027](https://github.com/MitchellThompkins/api/issues/2027)) ([6f94aa1](https://github.com/MitchellThompkins/api/commit/6f94aa19fca8d1a60624b06ec9d8c1f486d953f4))
* **plugin:** raise minimum unraid os version to 6.12.15 ([#1649](https://github.com/MitchellThompkins/api/issues/1649)) ([bc15bd3](https://github.com/MitchellThompkins/api/commit/bc15bd3d7008acb416ac3c6fb1f4724c685ec7e7))
* **plugin:** restore cleanup behavior for unsupported unraid versions ([#1658](https://github.com/MitchellThompkins/api/issues/1658)) ([534a077](https://github.com/MitchellThompkins/api/commit/534a07788b76de49e9ba14059a9aed0bf16e02ca))
* polish onboarding flow ([#1902](https://github.com/MitchellThompkins/api/issues/1902)) ([8742cac](https://github.com/MitchellThompkins/api/commit/8742cac0602aa67cc9d3eba3cdcfaed6980e714f))
* pr plugin promotion workflow ([#1456](https://github.com/MitchellThompkins/api/issues/1456)) ([13bd9bb](https://github.com/MitchellThompkins/api/commit/13bd9bb5670bb96b158068114d62572d88c7cae9))
* prepend 'v' to API version in workflow dispatch inputs ([f0cffbd](https://github.com/MitchellThompkins/api/commit/f0cffbdc7ac36e7037ab60fe9dddbb2cab4a5e10))
* preserve onboarding resume state on reload ([#1941](https://github.com/MitchellThompkins/api/issues/1941)) ([91f7fe9](https://github.com/MitchellThompkins/api/commit/91f7fe9759e0eb84de301b3373bf5eaffd9071b4))
* preserve registration device limits after refresh ([#1905](https://github.com/MitchellThompkins/api/issues/1905)) ([234bfc7](https://github.com/MitchellThompkins/api/commit/234bfc717f83beded89b1367e76eca9600bcdeda))
* prevent onboarding on API errors ([#1917](https://github.com/MitchellThompkins/api/issues/1917)) ([540d6f9](https://github.com/MitchellThompkins/api/commit/540d6f99b3cf2a4382163aa9ae7c73dfd82812ce))
* progress frame background color fix ([#1672](https://github.com/MitchellThompkins/api/issues/1672)) ([785f1f5](https://github.com/MitchellThompkins/api/commit/785f1f5eb1a1cc8b41f6eb502e4092d149cfbd80))
* progressFrame white on black ([0990b89](https://github.com/MitchellThompkins/api/commit/0990b898bd02c231153157c20d5142e5fd4513cd))
* properly override header values ([#1673](https://github.com/MitchellThompkins/api/issues/1673)) ([aecf70f](https://github.com/MitchellThompkins/api/commit/aecf70ffad60c83074347d3d6ec23f73acbd1aee))
* **rc.unraid-api:** remove profile sourcing ([#1622](https://github.com/MitchellThompkins/api/issues/1622)) ([6947b5d](https://github.com/MitchellThompkins/api/commit/6947b5d4aff70319116eb65cf4c639444f3749e9))
* re-add missing header gradient styles ([#1787](https://github.com/MitchellThompkins/api/issues/1787)) ([f8a6785](https://github.com/MitchellThompkins/api/commit/f8a6785e9c92f81acaef76ac5eb78a4a769e69da))
* recover VM availability after reconnect ([#1947](https://github.com/MitchellThompkins/api/issues/1947)) ([e064de7](https://github.com/MitchellThompkins/api/commit/e064de7d3701edbad1b397a8558f16115ea0bb81))
* refactor API client to support Unix socket connections ([#1575](https://github.com/MitchellThompkins/api/issues/1575)) ([a2c5d24](https://github.com/MitchellThompkins/api/commit/a2c5d2495ffc02efa1ec5c63f0a1c5d23c9ed7ff))
* release note escaping ([5b6bcb6](https://github.com/MitchellThompkins/api/commit/5b6bcb6043a5269bff4dc28714d787a5a3f07e22))
* reload var state when emhttp writes temp files ([#1950](https://github.com/MitchellThompkins/api/issues/1950)) ([7265105](https://github.com/MitchellThompkins/api/commit/7265105b0ff5de42cce174c3de1569c629f07721))
* remap TPM guid prefix to 01 ([#1924](https://github.com/MitchellThompkins/api/issues/1924)) ([5360b5b](https://github.com/MitchellThompkins/api/commit/5360b5b4255e6c51dd775c948f776ab9ac807055))
* remove connect api plugin upon removal of Connect Unraid plugin ([#1548](https://github.com/MitchellThompkins/api/issues/1548)) ([782d5eb](https://github.com/MitchellThompkins/api/commit/782d5ebadc67854298f3b2355255983024d2a225))
* remove unraid-api sso users & always apply sso modification on &lt; 7.2 ([#1595](https://github.com/MitchellThompkins/api/issues/1595)) ([4262830](https://github.com/MitchellThompkins/api/commit/426283011afd41e3af7e48cfbb2a2d351c014bd1))
* remove unused api key calls ([#1628](https://github.com/MitchellThompkins/api/issues/1628)) ([9cd0d6a](https://github.com/MitchellThompkins/api/commit/9cd0d6ac658475efa25683ef6e3f2e1d68f7e903))
* replace myservers.cfg reads in UpdateFlashBackup.php ([#1517](https://github.com/MitchellThompkins/api/issues/1517)) ([441e180](https://github.com/MitchellThompkins/api/commit/441e1805c108a6c1cd35ee093246b975a03f8474))
* resolve header flash when background color is set ([#1796](https://github.com/MitchellThompkins/api/issues/1796)) ([dc9a036](https://github.com/MitchellThompkins/api/commit/dc9a036c73d8ba110029364e0d044dc24c7d0dfa))
* resolve issue with "Continue" button when updating ([#1852](https://github.com/MitchellThompkins/api/issues/1852)) ([d099e75](https://github.com/MitchellThompkins/api/commit/d099e7521d2062bb9cf84f340e46b169dd2492c5))
* respect OS safe mode in plugin loader ([#1775](https://github.com/MitchellThompkins/api/issues/1775)) ([92af3b6](https://github.com/MitchellThompkins/api/commit/92af3b61156cabae70368cf5222a2f7ac5b4d083))
* retry VMs init for up to 2 min ([#1612](https://github.com/MitchellThompkins/api/issues/1612)) ([b2e7801](https://github.com/MitchellThompkins/api/commit/b2e78012384e6b3f2630341281fc811026be23b9))
* Return null for corrupted/invalid API key files and add Connect fixtures test ([#1886](https://github.com/MitchellThompkins/api/issues/1886)) ([013e6c5](https://github.com/MitchellThompkins/api/commit/013e6c5b416d28e5dfd473728a636ddc547b1560))
* Revert "fix(web): avoid legacy dropdown id collisions" ([#1961](https://github.com/MitchellThompkins/api/issues/1961)) ([ffeb148](https://github.com/MitchellThompkins/api/commit/ffeb148fb914aeb67b3a9ea8892bfac11614b6a6))
* revert replace docker overview table with web component (7.3+) ([#1853](https://github.com/MitchellThompkins/api/issues/1853)) ([560db88](https://github.com/MitchellThompkins/api/commit/560db880cc138324f9ff8753f7209b683a84c045))
* rm redundant emission to `$HOME/.pm2/logs` ([#1640](https://github.com/MitchellThompkins/api/issues/1640)) ([a8e4119](https://github.com/MitchellThompkins/api/commit/a8e4119270868a1dabccd405853a7340f8dcd8a5))
* rm short-circuit in `rc.unraid-api` if plugin config dir is absent ([#1515](https://github.com/MitchellThompkins/api/issues/1515)) ([29dcb7d](https://github.com/MitchellThompkins/api/commit/29dcb7d0f088937cefc5158055f48680e86e5c36))
* **server-identity:** handle onboarding persistence mismatches ([#1974](https://github.com/MitchellThompkins/api/issues/1974)) ([8432974](https://github.com/MitchellThompkins/api/commit/8432974569cd6acac166607bdda2aa78db4f1528))
* set input color in SSO field rather than inside of the main.css ([01d353f](https://github.com/MitchellThompkins/api/commit/01d353fa08a3df688b37a495a204605138f7f71d))
* share internal boot state across onboarding ([#1920](https://github.com/MitchellThompkins/api/issues/1920)) ([f9b293f](https://github.com/MitchellThompkins/api/commit/f9b293f7962816898e2ce710c90bf3df851e645e))
* sign out correctly on error ([#1452](https://github.com/MitchellThompkins/api/issues/1452)) ([d08fc94](https://github.com/MitchellThompkins/api/commit/d08fc94afb94e386907da44402ee5a24cfb3d00a))
* sign out doesn't work ([#1486](https://github.com/MitchellThompkins/api/issues/1486)) ([f3671c3](https://github.com/MitchellThompkins/api/commit/f3671c3e0750b79be1f19655a07a0e9932289b3f))
* SSO not being detected ([#1546](https://github.com/MitchellThompkins/api/issues/1546)) ([6b3b951](https://github.com/MitchellThompkins/api/commit/6b3b951d8288cd31d096252be544537dc2bfce50))
* staging PR plugin fixes + UI issues on 7.2 beta ([b79b44e](https://github.com/MitchellThompkins/api/commit/b79b44e95c65a124313814ab55b0d0a745a799c7))
* **startup:** defer connect and temperature boot tasks ([#1988](https://github.com/MitchellThompkins/api/issues/1988)) ([7b08ee2](https://github.com/MitchellThompkins/api/commit/7b08ee2ddf73a6d92a76a51721edf88dc2811934)), closes [#1989](https://github.com/MitchellThompkins/api/issues/1989)
* **state-watch:** watch canonical ini files atomically ([#1953](https://github.com/MitchellThompkins/api/issues/1953)) ([6471b3f](https://github.com/MitchellThompkins/api/commit/6471b3f542f549e90e7051f332294ed2b2807890))
* **theme:** API key white text on white background ([#1584](https://github.com/MitchellThompkins/api/issues/1584)) ([b321687](https://github.com/MitchellThompkins/api/commit/b3216874faae208cdfc3edec719629fce428b6a3))
* **theme:** Missing header background color ([e2fdf6c](https://github.com/MitchellThompkins/api/commit/e2fdf6cadbd816559b8c82546c2bc771a81ffa9e))
* **theme:** remove stale dark root class in light mode ([#1960](https://github.com/MitchellThompkins/api/issues/1960)) ([2815f85](https://github.com/MitchellThompkins/api/commit/2815f8567cc775e81471a20989a4ad8b4326cba0))
* **theme:** update theme class naming and scoping logic ([b28ef1e](https://github.com/MitchellThompkins/api/commit/b28ef1ea334cb4842f01fa992effa7024185c6c9))
* too many file descriptors with thousands of notifications ([#1887](https://github.com/MitchellThompkins/api/issues/1887)) ([7956987](https://github.com/MitchellThompkins/api/commit/79569872e89214db1414cfa118505b6aefddc988))
* Treat onboarding patch updates as completed ([#1884](https://github.com/MitchellThompkins/api/issues/1884)) ([d03b25e](https://github.com/MitchellThompkins/api/commit/d03b25ebf8ca7c33c70c59e9c07f82553342f5cd))
* trigger deployment ([a27453f](https://github.com/MitchellThompkins/api/commit/a27453fda81e4eeb07f257e60516bebbbc27cf7a))
* truncate log files when they take up more than 5mb of space ([#1530](https://github.com/MitchellThompkins/api/issues/1530)) ([0a18b38](https://github.com/MitchellThompkins/api/commit/0a18b38008dd86a125cde7f684636d5dbb36f082))
* Unify callback server payloads ([#1938](https://github.com/MitchellThompkins/api/issues/1938)) ([f58fcc0](https://github.com/MitchellThompkins/api/commit/f58fcc028ce745764d28f0409525b5ec08da57ad))
* unify onboarding internal boot state refresh ([#1923](https://github.com/MitchellThompkins/api/issues/1923)) ([d3032c1](https://github.com/MitchellThompkins/api/commit/d3032c18782a27666811b230ca2025579d02c96a))
* unraid-connect plugin not loaded when connect is installed ([#1856](https://github.com/MitchellThompkins/api/issues/1856)) ([73135b8](https://github.com/MitchellThompkins/api/commit/73135b832801f5c76d60020161492e4770958c3d))
* UnraidToaster component and update dialog close button ([#1657](https://github.com/MitchellThompkins/api/issues/1657)) ([44774d0](https://github.com/MitchellThompkins/api/commit/44774d0acdd25aa33cb60a5d0b4f80777f4068e5))
* update @unraid/shared-callbacks to version 3.0.0 ([#1831](https://github.com/MitchellThompkins/api/issues/1831)) ([73b2ce3](https://github.com/MitchellThompkins/api/commit/73b2ce360c66cd9bedc138a5f8306af04b6bde77))
* update Docusaurus PR workflow to process and copy API docs ([3a10871](https://github.com/MitchellThompkins/api/commit/3a10871918fe392a1974b69d16a135546166e058))
* update GitHub Actions token for workflow trigger ([4d8588b](https://github.com/MitchellThompkins/api/commit/4d8588b17331afa45ba8caf84fcec8c0ea03591f))
* update myservers config references to connect config references ([#1810](https://github.com/MitchellThompkins/api/issues/1810)) ([e1e3ea7](https://github.com/MitchellThompkins/api/commit/e1e3ea7eb68cc6840f67a8aec937fd3740e75b28))
* update OIDC provider setup documentation for navigation clarity ([1a01696](https://github.com/MitchellThompkins/api/commit/1a01696dc7b947abf5f2f097de1b231d5593c2ff))
* update OIDC provider setup documentation for redirect URI and screenshots ([1bc5251](https://github.com/MitchellThompkins/api/commit/1bc52513109436b3ce8237c3796af765e208f9fc))
* update OIDC URL validation and add tests ([#1646](https://github.com/MitchellThompkins/api/issues/1646)) ([c7c3bb5](https://github.com/MitchellThompkins/api/commit/c7c3bb57ea482633a7acff064b39fbc8d4e07213))
* **ups:** convert estimatedRuntime from minutes to seconds ([#1822](https://github.com/MitchellThompkins/api/issues/1822)) ([024ae69](https://github.com/MitchellThompkins/api/commit/024ae69343bad5a3cbc19f80e357082e9b2efc1e))
* use async for primary file read/writes ([#1531](https://github.com/MitchellThompkins/api/issues/1531)) ([23b2b88](https://github.com/MitchellThompkins/api/commit/23b2b8846158a27d1c9808bce0cc1506779c4dc3))
* use relative URLs in the web links and fix color in PM2 startup ([#1752](https://github.com/MitchellThompkins/api/issues/1752)) ([f212dce](https://github.com/MitchellThompkins/api/commit/f212dce88b847cb6d3187b313c0f8ccae8aadda2))
* use shared bg & border color for styled toasts ([#1647](https://github.com/MitchellThompkins/api/issues/1647)) ([7c3aee8](https://github.com/MitchellThompkins/api/commit/7c3aee8f3f9ba82ae8c8ed3840c20ab47f3cb00f))
* use unraid css variables in sonner ([#1634](https://github.com/MitchellThompkins/api/issues/1634)) ([26a95af](https://github.com/MitchellThompkins/api/commit/26a95af9539d05a837112d62dc6b7dd46761c83f))
* use virtual-modal-container ([#1709](https://github.com/MitchellThompkins/api/issues/1709)) ([44b4d77](https://github.com/MitchellThompkins/api/commit/44b4d77d803aa724968307cfa463f7c440791a10))
* vue mounting logic with tests ([#1651](https://github.com/MitchellThompkins/api/issues/1651)) ([33774aa](https://github.com/MitchellThompkins/api/commit/33774aa596124a031a7452b62ca4c43743a09951))
* **web:** avoid dropdown id collisions with ZFS Master ([#1958](https://github.com/MitchellThompkins/api/issues/1958)) ([98d37bb](https://github.com/MitchellThompkins/api/commit/98d37bbe7f5e2381feeebe9cdfa5550ed9f7d11a))
* **web:** include connect metadata in callbacks ([#1957](https://github.com/MitchellThompkins/api/issues/1957)) ([c392146](https://github.com/MitchellThompkins/api/commit/c3921466431c8c797640a3ad0972b7f1710ef555))
* **web:** refresh internal boot onboarding state ([#1913](https://github.com/MitchellThompkins/api/issues/1913)) ([1ca2129](https://github.com/MitchellThompkins/api/commit/1ca21291b80ac212957a55c403744b4c990eaed2))
* **web:** restore dropdown id compatibility safely ([#1962](https://github.com/MitchellThompkins/api/issues/1962)) ([d948b32](https://github.com/MitchellThompkins/api/commit/d948b32cfeb9e232866bea8e49c8f6707dba0ca4))
* **web:** stop showing callback errors after successful key installs ([#1892](https://github.com/MitchellThompkins/api/issues/1892)) ([45f1402](https://github.com/MitchellThompkins/api/commit/45f140207a03047121e5003fc23e311ef6c077ed))
* **web:** unify UPC license actions into manage/trial entry ([#1929](https://github.com/MitchellThompkins/api/issues/1929)) ([164198c](https://github.com/MitchellThompkins/api/commit/164198c25def22c99e475d301ef71b7ca2ac1615))
* white on white login text ([ae4d3ec](https://github.com/MitchellThompkins/api/commit/ae4d3ecbc417454ae3c6e02018f8e4c49bbfc902))


### Reverts

* revert package.json dependency updates from commit 711cc9a for api and packages/* ([94420e4](https://github.com/MitchellThompkins/api/commit/94420e4d45735b8def3915b5789c15c1c3121f1e))
